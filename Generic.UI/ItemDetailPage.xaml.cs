...
namespace Generic.UI
{
    ...
    /// within the group.
    /// </summary>
    public sealed partial class ItemDetailPage : Generic.UI.Common.LayoutAwarePage
    {

        private static ResourceLoader loader = new ResourceLoader();

        ParentViewModel selectedTrip = new ParentViewModel();
        ...
        async private void btnSelectPhoto_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
                ...
                if (selectedFile != null)
                {
                    ...
                    if (!oldImage.Equals(loader.GetString("DefaultParentImage")))
                    {
                        try
                        {
